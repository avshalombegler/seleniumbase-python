...
class EntryAdPageLocators:
    ...
    MODAL_LOADED_INDICATOR: Locator = {"selector": "#modal", "by": By.CSS_SELECTOR}
    CLOSE_BTN: Locator = {"selector": "#modal .modal-footer p", "by": By.CSS_SELECTOR}
    RE_ENABLE_LINK: Locator = {"selector": "restart-ad", "by": By.ID}
